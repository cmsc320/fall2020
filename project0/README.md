...
`git clone https://github.com/cmsc320/fall2020.git`

You can do `git pull` (from within the `fall2020` directory) to fetch the newly added material. 
...
- Clone the class repository:
    - In Terminal: `git clone git@github.com:cmsc320/fall2020.git`
